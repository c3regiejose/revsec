...
// Include settings for staging
if (getenv('IS_STAGING_ENV') == 'true' && file_exists(__DIR__ . '/settings.staging.php')) {
  include __DIR__ . '/settings.staging.php';
}

// Include settings for production
if (getenv('IS_PRODUCTION_ENV') == 'true' && file_exists(__DIR__ . '/settings.production.php')) {
